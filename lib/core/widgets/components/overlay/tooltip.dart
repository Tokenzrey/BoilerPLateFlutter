...
//     // Ambil warna background utama
//     Color backgroundColor = theme.colorScheme.primary;

//     // Terapkan opacity custom kalau ada
//     if (surfaceOpacity != null) {
//       backgroundColor = backgroundColor.withValues(alpha: surfaceOpacity!);
//     }

//     // Hardcode gaya teks untuk xSmall + primaryForeground
//     // Misal xSmall = bodySmall di textTheme, dan primaryForeground = onPrimary
//     final TextStyle tooltipTextStyle = theme.textTheme.bodySmall!.copyWith(
//       color: theme.colorScheme.onPrimary,
//     );

//     Widget tooltipBody = Container(
...
//     // Terapkan blur layer kalau diminta
//     if (surfaceBlur != null && surfaceBlur! > 0) {
//       tooltipBody = SurfaceBlur(
